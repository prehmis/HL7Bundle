...
final class T0211 extends ReadableEnum
{
    ...
    public static function choices(): array
    {
        return [
            ...
            self::ISO_IR6 => 'ASCII graphic character set consisting of 94 characters.',
            ...
            self::UNICODE => 'The world wide character standard from ISO/IEC 10646-1-1993',
            self::UNICODE_UTF_16 => 'UCS Transformation Format, 16-bit form',
            self::UNICODE_UTF_32 => 'UCS Transformation Format, 32-bit form',
            self::UNICOD_UTF_8 => 'UCS Transformation Format, 8-bit form',
            ];
    }
