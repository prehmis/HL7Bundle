...
final class T0278 extends ReadableEnum
{
    ...
    {
        return [
            self::BLOCKED => 'The indicated time slot(s) is(are) blocked. Not used in the AIS,  AIG,  AIL,  AIP segments.',
            self::BOOKED => 'The indicated appointment is booked',
            self::CANCELLED => 'The indicated appointment was stopped from occurring (cancelled prior to starting)',
