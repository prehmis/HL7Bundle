...
final class T0277 extends ReadableEnum
{
    ...
    {
        return [
            self::COMPLETE => 'A request to add a completed appointment, used to maintain records of completed appointments that did not appear in the schedule (e.g., STAT, w alk-in, etc.)',
