...
class Segment
{
    ...
    {
        if ($index === self::NAME) { // Do not allow changing 0th index, which is the name of the segment
            throw new \InvalidArgumentException('Changing 0th index is not allowed as it is the name of the segment');
        }
     ...
     * @return Prehmis\HL7Bundle\Segments\Segment
     */
    public function clearField(int $index): Segment
    {
